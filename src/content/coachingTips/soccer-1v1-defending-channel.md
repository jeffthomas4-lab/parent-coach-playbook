---
title: "1v1 Defending in a Channel"
summary: "Defender stops the attacker from advancing through a cone channel. 10 minutes. Ages 8-10."
sport: "soccer"
ages: ["8-10"]
...
featured: false
illustrationBrief: "Attacker trying to dribble through a channel marked by cones while defender blocks the path."
editorial:
  qualityGrade: 8
  originalityGrade: 7
  voiceGrade: 8
...
1. Using Drop, Show, Stay, Win cue: defender drops back foot, shows one direction (left or right), stays patient, wins the ball.
2. Attacker dribbles toward the defender using Touch, Look, Push, Go.
3. Defender forces the attacker toward one cone wall.
4. When the attacker commits to that direction, defender pokes the ball away.
