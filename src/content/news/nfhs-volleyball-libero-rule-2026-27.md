---
headline: "High school volleyball teams can now roster two liberos, not just one"
summary: "NFHS approved seven volleyball rule changes for the 2026-27 season, effective this fall. Teams may designate up to two liberos per set, though only one can be on the court at a time, and the libero's uniform bottom no longer has to match the rest of the team's, only the jersey top does. If your daughter's team suddenly has two different players rotating in as the libero, this is why."
