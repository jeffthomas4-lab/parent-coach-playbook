...
<div class="my-8">
  <article class="border border-bone bg-paper-warm p-6 flex flex-col">
    ...
    <h3 class="font-display text-ink text-2xl font-semibold leading-tight" style="margin: 0;">Bauer Lil Sport Helmet Combo with Cage</h3>
    <p class="font-display text-ink-soft mt-4 leading-snug" style="margin-top: 1rem; margin-bottom: 0;">Bauer's youth starter helmet with the full cage already attached. HECC certified, one adjustable youth size covers most learn-to-skate heads, and the cage is fixed so you're not buying two pieces.</p>
    <p class="font-display text-ink mt-4 italic border-l-2 border-rust pl-3 leading-snug" style="margin-top: 1rem; margin-bottom: 0;">Our take: The helmet is the one piece you buy new, every time. Buy it once and buy the known brand. Everything else on this list can come from the used rack.</p>
    <a href="/go/hockey-helmet-youth/" rel="sponsored nofollow noopener" class="btn mt-6 self-start">See it at Amazon ↗</a>
  </article>
...
<div class="my-8">
  <article class="border border-bone bg-paper-warm p-6 flex flex-col">
    <div class="t-label text-ink-soft mb-2 text-xs">Amazon · Hockey · Ages 5–9</div>
    <h3 class="font-display text-ink text-2xl font-semibold leading-tight" style="margin: 0;">Franklin Ripper Youth Hockey Stick</h3>
    <p class="font-display text-ink-soft mt-4 leading-snug" style="margin-top: 1rem; margin-bottom: 0;">Franklin Ripper youth hockey stick with a right or left-hand blade option. Lightweight build for small players, sized for beginners, and priced low enough that you won't be heartbroken when it gets chewed up by the ice.</p>
    <p class="font-display text-ink mt-4 italic border-l-2 border-rust pl-3 leading-snug" style="margin-top: 1rem; margin-bottom: 0;">Our take: The right first stick. It won't last forever and it doesn't need to. Your kid is learning to skate and handle — not optimizing flex profiles.</p>
    <a href="/go/hockey-stick-youth/" rel="sponsored nofollow noopener" class="btn mt-6 self-start">See it at Amazon ↗</a>
  </article>
  <p class="t-label text-ink-soft mt-3 text-xs" style="text-transform: none; letter-spacing: 0;">As an Amazon Associate we earn from qualifying purchases.</p>
</div>
