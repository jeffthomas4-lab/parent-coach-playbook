...
Use the [cost calculator](/cost-calculator/) to build an honest season budget.
...
See [the pendulum conversation](/youth-sports-pendulum/) for how to start this without it becoming a crisis.
...
The [recruiting guide](/recruiting/) covers what to include in a first message to a college coach, when to attend ID camps, and how to read the difference between real interest and courtesy.
...
Check the [season calendar](/season-calendar/) for a visual map of how softball layers across the school year.
...
The [recruiting guide](/recruiting/) covers the full outreach framework and what different division levels look for.
