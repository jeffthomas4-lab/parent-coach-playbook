---
title: "The Ultimate Parent Guide to Hockey"
seoTitle: "Youth Hockey for Parents: The Complete Guide"
seoDescription: "Everything youth hockey parents need to know — costs, gear, levels, what coaches want, and how to actually help."
sport: hockey
...
**Beginner/House Level.**
**Skates:** The most important piece of equipment. Skates must fit correctly: heel locked in, minimal toe room, stiff enough to support the ankle. A beginner [skate](/go/hockey-skates-youth/) from Bauer, CCM, or Graf in the entry range runs value to moderately priced. Do not buy skates without trying them on at a hockey shop. Sizing is not like shoe sizing. **Helmet with cage:** A full cage is required at all youth levels. A certified youth [helmet](/go/hockey-helmet-youth/) with a cage attached runs moderately priced. The HECC certification is the standard. **Neck guard:** Required in most associations. A basic cut-resistant neck guard runs value tier. **Shoulder pads:** Entry-level youth shoulder pads run value to moderately priced. **Elbow pads:** Value tier. **Gloves:** Value to moderately priced. **Shin guards:** Value to moderately priced. **Hockey pants (breezers):** Moderately priced. **Jock or jill:** Value tier. **Stick:** A beginner composite or wood [stick](/go/hockey-stick-youth/) runs value tier. **Bag:** You need a bag large enough to carry all of this. A basic hockey bag runs value tier.

Total [starter set](/go/hockey-pads-starter/) at the house level: a value to moderately priced range before you account for skate sharpening and any rink-specific requirements.

**Travel/Club Level.**
At the travel level, gear quality matters more. Better skates make better skaters. The upgrades that provide real performance benefit are skates, gloves, and stick.
...
Use the [cost calculator](/cost-calculator/) to build a realistic season budget.
...
Check the [season calendar](/season-calendar/) for tryout dates and regional schedules.
...
Read the full picture at [/recruiting/](/recruiting/) and use the [pathways tool](/pathways/) to match your player's level to realistic options.
