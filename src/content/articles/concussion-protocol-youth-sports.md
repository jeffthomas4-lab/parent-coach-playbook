---
title: "Concussion Protocol for Youth Sports: Scripts for Parents and Coaches"
seoTitle: "Concussion Protocol for Youth Sports"
seoDescription: "A practical playbook that translates CDC HEADS UP into sideline scripts, checklists, and clinician questions parents and coaches can use. Practical guidance…"
dek: "If you suspect a concussion in a youth athlete, remove them from play right now. Check for danger signs that need emergency care. Get them evaluated by a healthcare provider before they take one more step on the field."
bluf: "If you suspect a concussion in a youth athlete, remove them from play right now. Check for danger signs that need emergency care. Get them evaluated by a healthcare provider before they take one more step on the field. No same-day return, no exceptions, no matter how badly your team needs them."
topic: "communication"
format: "essay"
phase: "game"
sport: "multi-sport"
...
externalSource:
  ...
  articleId: "843653"
  payloadSha256: "c43ade6729df94ffd1e5b5f0aef40067a6405f720f94983d3fffc7dbd4cd7e9c"
  importedAt: "2026-09-13T04:00:11.099Z"
editorial:
  status: published
...
- [What Is a Concussion Protocol in Youth Sports?](#what-is-a-concussion-protocol-in-youth-sports)
- [What Are the Signs of a Concussion in a Young Athlete?](#what-are-the-signs-of-a-concussion-in-a-young-athlete)
- [What Should You Do in the First Hour After a Suspected Concussion?](#what-should-you-do-in-the-first-hour-after-a-suspected-concussion)
- [How Does the Six-Step Return-to-Play Progression Work?](#how-does-the-six-step-return-to-play-progression-work)
- [What Does Return to Learn Look Like After a Concussion?](#what-does-return-to-learn-look-like-after-a-concussion)
- [How Do State Concussion Laws Apply to Club and Recreational Teams?](#how-do-state-concussion-laws-apply-to-club-and-recreational-teams)
- [What Should a Team's Written Concussion Protocol Include?](#what-should-a-teams-written-concussion-protocol-include)
- [What Should You Ask the Doctor, and How Do You Track Recovery?](#what-should-you-ask-the-doctor-and-how-do-you-track-recovery)
- [Parent Coach Desk Resources That Support This Protocol](#parent-coach-desk-resources-that-support-this-protocol)
- [A Parent-Coach's Honest Take on Concussion Safety](#a-parent-coachs-honest-take-on-concussion-safety)
- [Give Your Season a Real Safety Foundation Before It Starts](#give-your-season-a-real-safety-foundation-before-it-starts)
- [Sources](#sources)
- [FAQ](#faq)
...
3. A headache that keeps getting worse, not better
4. Drowsiness or an inability to wake up
5. Weakness, numbness, or decreased coordination on one side of the body
6. Slurred speech, seizures, or convulsions
7. Loss of consciousness, even briefly
...
1. **Remove and stabilize.** Get the athlete off the field or court to a quiet spot, away from the noise and lights of the game. Have one adult, ideally the parent or a trained staff member, stay with them the entire time. Never leave a possibly concussed athlete alone.
2. **Check and record.** Look for the danger signs above. Then write down the basics: time of injury, mechanism (what caused it), whether there was any loss of consciousness, whether the athlete has any memory gaps around the event, and whether they've had a prior concussion.
3. **Notify and arrange evaluation.** Call the parent or guardian immediately if they weren't already there. If any danger sign is present, that's an emergency department visit, full stop. If not, arrange an outpatient evaluation with a healthcare provider as soon as possible, ideally within 24 hours.
4. **Preserve the paperwork.** Use a written incident form, not a memory. Include the time, symptoms observed, actions taken, and who was notified. This record travels with the athlete to the clinician and, later, to the school.
...
Most concussions resolve within a couple of weeks. If symptoms drag on past two to four weeks, or if they're getting worse instead of better, it's time for a referral to a specialist experienced in [treating brain injuries](https://www.ncbi.nlm.nih.gov/books/NBK448119/), not another wait-and-see week with the general pediatrician.
...
A [review of state concussion laws](https://pmc.ncbi.nlm.nih.gov/articles/PMC6378501/) found real variability in who is legally allowed to clear an athlete for return, some states require a physician specifically, others allow a broader range of licensed providers, and whether the law spells out a graduated RTP progression at all, or just says "get cleared" without specifying how.
...
Well-fitted equipment plays a supporting role here too, not a starring one. A properly fitted helmet or [durable, well-maintained gear](https://rnkapparel.com/blogs/rnk-news/why-youth-athletes-need-durable-gear) reduces certain injury risks in contact sports, though no equipment, including mouth guards, eliminates concussion risk entirely. [Mouth guards](https://clearretain.com/blogs/blog/contact-sport-mouth-guard-benefits-2026-athlete-guide) protect teeth and jaws in contact sports, which matters, but don't market them to your team as concussion prevention. That's not what they're built for.
...
1. Are you familiar with return-to-learn planning, not just return-to-play?
2. Based on what you're seeing today, what's a realistic recovery timeline?
3. What symptoms should prompt an immediate call back to your office?
4. At what point would you refer to a specialist if symptoms haven't resolved?
...
Our [Parent Toolkit for youth sports safety](/blog/youth-sports-safety/) covers five immediate steps you can drop straight into a preseason parent packet alongside the checklist in this guide. If your athlete plays a contact-heavy sport, our guide on [football concussions and what parents need to know](/drive-there/football-concussion-what-parents-need-to-know/) walks through sport-specific risk conversations you can have before the pads even go on.

Start with our [parents' guide to youth sports](/start-here/) if you're newer to organized sports altogether and want the fuller picture beyond just concussion management, season planning, tryouts, communication with coaches, all of it lives in one place. And if you want season prep reminders and updated templates delivered before you need them instead of after, the newsletter is built exactly for that.
...
If your athlete is in the 7 to 9 age range, our [coaching guide for that golden age of youth sports](/team-parent/coaching-7-9-year-olds-golden-age-youth-sports/) pairs season planning with the kind of communication habits that make safety conversations normal instead of scary. For preteens heading into more competitive play, the [10 to 12 coaching guide](/team-parent/coaching-10-12-year-olds-competitive-prep/) covers the readiness and safety planning that matters as contact and intensity ramp up. Grab the checklist from this article, print it, and drop it into your preseason parent packet this week. Then sign up for the newsletter so the next update to these templates lands in your inbox instead of getting lost in a coach's group text.

This article is general information, not a substitute for advice from a qualified doctor. Consult a qualified healthcare professional about your own circumstances before acting on anything here.

## Sources

- [Responding to a Sports-related Concussion | HEADS UP | CDC](https://www.cdc.gov/heads-up/response/index.html)
- [The Clinical Implications of Youth Sports Concussion Laws: A Review](https://pmc.ncbi.nlm.nih.gov/articles/PMC6378501/)
...
- [Parent Toolkit: 5 Immediate Steps for Youth Sports Safety](/blog/youth-sports-safety/)
- [Football concussions: what youth sports parents need to know](/drive-there/football-concussion-what-parents-need-to-know/)
