---
title: "How to Read Your Kid's UTR Profile for Recruiting"
seoTitle: "Reading a UTR Profile: Verified Rating, Reliability, and Recruiting"
seoDescription: "What the numbers on a UTR profile actually mean for college tennis recruiting: verified rating, reliability, singles versus doubles, and trend direction."
dek: "The UTR app shows a number, a color, and a graph. All three mean something different to a college coach reading the same profile."
bluf: "A UTR profile has several parts that matter differently for recruiting: the singles rating, the doubles rating, the verified badge, and the reliability status. College coaches weight verified singles UTR most heavily, want to see a rising trend rather than a flat one, and mostly ignore unverified results from casual matches. Knowing what a coach actually looks at changes which tournaments and matches are worth entering."
format: "essay"
phase: "drive-there"
sport: "tennis"
age: "15-plus"
...
None of this replaces actually knowing where that number sits against real team rosters, which the [tennis recruiting pathway](/pathways/tennis/) walks through by division and level.
