---
title: "Building a Swimming Recruiting Profile Coaches Will Actually Look At"
seoTitle: "How to Build a College Swim Recruiting Profile Coaches Will Read"
seoDescription: "A practical guide to building a swimming recruiting profile using SwimCloud and USA Swimming times, and what actually gets a coach's attention."
dek: "The profile is not a highlight reel. It's a times sheet, kept current, that a coach can check in under a minute."
bluf: "A swimming recruiting profile is built almost entirely on verified times, not video or essays, using SwimCloud and USA Swimming's public database. Keep it current, keep it accurate, and lead every email with the times a coach needs to evaluate interest in under a minute. The families who get responses are the ones who make it easy to check, not the ones who make the biggest pitch."
format: "essay"
phase: "drive-there"
sport: "swimming"
age: "15-plus"
...
None of this replaces genuinely fast swimming. But two swimmers with similar times don't always get equal attention, and the one whose family made the profile easy to check usually hears back first. [The swimming pathway](/pathways/swimming/) is worth reading alongside this if you're still working out where your swimmer's current times sit relative to what different program levels actually recruit.
