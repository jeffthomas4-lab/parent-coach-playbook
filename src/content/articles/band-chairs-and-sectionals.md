...
dek: First chair, second chair, sectionals, challenges. The ranking system feels brutal
  at 11. Here is how it works and what it actually means.
seoDescription: Middle school bands rank players by chair within each section. Here
  is how the chair system works and how to talk to your kid about it.
bluf: Middle school bands seat players in chairs within each section, with first chair
  being the strongest. Chairs are usually assigned by audition or challenge. The chair
  number matters less than parents think. It is a snapshot of one audition, not a
  verdict on the kid.
topic: communication
format: essay
phase: drive-home
