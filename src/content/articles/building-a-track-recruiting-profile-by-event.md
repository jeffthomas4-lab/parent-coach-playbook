---
title: "Building a track recruiting profile, by event"
seoTitle: "Building a Track Recruiting Profile by Event"
seoDescription: "How to build a track recruiting profile that fits your kid's event: Athletic.net and MileSplit setup, which meets matter, and what coaches check first."
dek: "A sprinter's profile and a thrower's profile should not look the same. Here's how to build the one your kid actually needs."
bluf: "A track recruiting profile starts with a clean, current Athletic.net or MileSplit page, but what belongs on it changes by event group. Sprinters need relay splits with individual times. Distance runners need cross country linked to track progression. Throwers and jumpers need video showing technical form, since a mark alone tells a coach less than a movement pattern does. Meet selection matters too: bigger, faster invitationals get checked more than small dual meets."
format: "essay"
phase: "drive-there"
sport: "track-field"
age: 15-plus
...
The [track and field pathway](/pathways/track-field/) is useful background here too, since it shows how event specialization develops through the teenage years. It affects how a coach reads a profile that specialized early versus one that specialized late.
