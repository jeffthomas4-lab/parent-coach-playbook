---
title: "STUNT sanctioning is a patchwork right now, and that's a real planning problem"
seoTitle: "STUNT State Sanctioning: The Patchwork Problem for Parents"
seoDescription: "STUNT is sanctioned as a full varsity sport in some states and barely exists in others. What that patchwork actually means for a family and what to do about it."
dek: "Your kid's zip code decides more about her STUNT future than her skill level does right now."
bluf: "STUNT is a state-by-state varsity sport, not a national one, and the sanctioning map is uneven. Some states run it as a full CIF or state-association sport with a real state championship. Others have it as a club activity, a pilot program in a handful of districts, or nothing at all. A family in a strong STUNT state and a family in a state with none of this infrastructure are looking at two completely different pictures, and knowing which one you're in changes the whole plan."
format: "essay"
phase: "drive-there"
sport: "stunt"
age: 15-plus
...
The [STUNT pathway](/pathways/stunt/) covers the skill benchmarks your athlete needs regardless of which state she's in, because that part doesn't change. What changes is whether there's a program waiting for those skills or a program you have to help build first.
