---
title: "The concussion call is not yours to make"
seoTitle: "The concussion call is not yours to make"
seoDescription: "Every state has a youth concussion law modeled on Washington's Zackery Lystedt law. What it actually requires from the parent who is also the coach."
dek: "Every state has a concussion law. Knowing it removes the guesswork from the sideline."
bluf: "Every state has a concussion law requiring immediate removal from play and written medical clearance before return. The coach's job is not to judge how serious a hit looks. It is to apply the rule the same way every time, including when the athlete is your own kid."
