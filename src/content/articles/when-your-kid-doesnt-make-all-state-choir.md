...
Choir doesn't get talked about as a cut sport, but it runs one anyway. Top choir, chamber ensemble, section leader. Every one of those is a placement decision with a smaller number of spots than kids who want them, and the [choir pathway](/pathways/choir/) is honest that this hierarchy stings like any depth chart.
