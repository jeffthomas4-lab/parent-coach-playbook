---
title: The Hockey Game Day Packing List
dek: The bag check that prevents the 6am rink panic, plus the spares that save a game.
seoTitle: "Hockey Game Day Packing List: The Full Bag Check"
seoDescription: "The complete hockey game day packing list: every pad in the bag check, skates and guards, spare laces and tape, base layers, and warm gear for the rink. Printable."
bluf: "Run the bag check the night before: skates with guards, helmet, shoulder pads, elbow pads, gloves, breezers, shin guards, hockey socks, jersey, neck guard, cup, base layers. Then the save-the-game kit: spare laces, two rolls of tape, a backup mouthguard, and a stick that isn't cracked."
topic: season-ops
format: note
phase: drive-there
sport: hockey
...
This list comes from hockey families who have done the drive of shame back home. [Printable version here](/hockey-game-day-packing-list.pdf).
