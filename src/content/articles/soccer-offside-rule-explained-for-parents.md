---
title: "The offside rule in soccer, explained for parents"
seoTitle: "Soccer offside rule explained for parents"
seoDescription: "The offside rule confuses almost every soccer parent. Here's the clearest explanation of how it works and why your kid was or wasn't actually offside."
dek: "The clearest explanation of a rule that confuses almost every soccer parent."
bluf: "A player is offside if they are nearer to the opponent's goal line than both the ball and the second-to-last defender when the ball is played to them. The moment the ball is kicked, not when the player receives it, is when the position is judged. It only applies in the opponent's half."
format: "note"
phase: "game"
sport: "soccer"
age: "all-ages"
