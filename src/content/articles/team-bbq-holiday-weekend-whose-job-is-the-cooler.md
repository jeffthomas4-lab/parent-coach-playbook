---
title: "The Team BBQ on a Holiday Weekend: Whose Job Is the Cooler"
seoTitle: "Team BBQ Logistics on a Holiday Weekend: Who Organizes It"
seoDescription: "The team potluck lands on a holiday weekend and someone has to organize it. Why that job tends to fall on the same person and what actually fixes it."
dek: "Someone has to bring the cooler, coordinate the sides, and answer forty texts about start time. It's rarely a coin flip who that someone is."
bluf: "Team BBQs on holiday weekends run smoothly when the organizing work is split explicitly instead of defaulting to whichever parent usually handles it. Naming specific jobs, main dish, sides, drinks, cooler, cleanup, and assigning them by sign-up rather than assumption prevents one person from quietly doing it all again. The invisible labor problem isn't solved by gratitude after the fact. It's solved by a list before the event."
format: "note"
phase: "team-parent"
sport: "multi-sport"
age: "all-ages"
