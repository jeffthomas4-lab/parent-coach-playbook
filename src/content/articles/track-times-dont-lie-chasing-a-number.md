---
title: "Track Times Don't Lie: Talking to a Kid Who's Chasing a Number"
seoTitle: "When Your Track Kid Is Obsessed With Beating One Time"
seoDescription: "A kid fixated on a single personal-best time in track can miss real progress. Here's how one drive-home conversation reframed the number without dismissing it."
dek: "He'd run the same 400 four times that season and improved every time. All he could talk about was the one race where he hadn't."
bluf: "When a kid fixates on a single personal-best time instead of overall progress, the fix isn't to tell them the number doesn't matter. It's to put that one number next to the four races around it and let them see the trend line themselves. Track times are public and permanent, which makes the obsession understandable, not a problem to correct with a pep talk."
format: "note"
phase: "drive-home"
sport: "track-field"
age: "11-12"
