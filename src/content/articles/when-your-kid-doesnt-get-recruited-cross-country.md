---
title: "When your kid doesn't get recruited for college cross country"
seoTitle: "When your kid doesn't get recruited for college cross country"
seoDescription: "Your runner put in years of training and the recruiting emails never came. How to process it honestly, what options are still open, and how to have the conversation."
dek: "How to process it, what options are still open, and how to have the honest conversation."
bluf: "Most high school cross country runners, including very good ones, do not get recruited to run in college. Walk-on spots, club running, and D3 programs that recruit on fit rather than scholarship dollars are all real paths that stay open after the recruiting emails stop coming. The conversation is hard. It is also one of the most useful ones you will have with your kid."
format: "essay"
phase: "drive-home"
sport: "cross-country"
age: 15-plus
...
**D3 programs recruiting on fit, not dollars.** D3 offers no athletic scholarships, which means D3 coaches recruit purely on whether a kid will show up, train, and fit the team. Some of the most competitive distance programs in the country are D3, and the financial aid packages at these schools can rival a partial D2 scholarship once you run the real numbers. The [cross country pathway by age](/pathways/cross-country/) is worth a look here too, since it shows how many strong college runners were never top recruits out of high school.
