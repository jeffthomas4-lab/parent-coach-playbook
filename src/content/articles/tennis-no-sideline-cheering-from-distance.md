---
title: "Tennis Has No Sideline: Learning to Cheer From Two Hundred Feet Away"
seoTitle: "Tennis Sideline Etiquette: Cheering From Far Away and Staying Quiet"
seoDescription: "Tennis parents watch matches from a distance and under strict quiet rules between points. Here's how to adjust from loud sideline sports to tennis etiquette."
dek: "We were sitting two courts down because that's as close as the fence let us get, straining to see which ball had landed out, and reminding ourselves for the tenth time not to yell during a point."
bluf: "Tennis matches are watched from a distance, often behind a fence separated from the court by several feet or more, and etiquette requires silence during points, no coaching, and no audible reactions to line calls. Parents used to close, loud sidelines have to adjust to cheering only between points and games, and to trusting a kid to handle calls and pressure without in-match input. The distance and the quiet are both part of what tennis asks of a player."
format: "note"
phase: "game"
sport: "tennis"
age: "all-ages"
