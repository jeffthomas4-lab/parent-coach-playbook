---
title: "Marching band vs concert band vs music major: the three paths"
seoTitle: "Marching Band vs Concert Band vs Music Major: Which Path Fits"
seoDescription: "The three different tracks a high school musician can be on, how to tell which one your kid is actually on, and why the gear and goals differ by path."
dek: "Three tracks, three different sets of goals, and most families never sit down to figure out which one they're on."
bluf: "Marching band is largely a fall activity that can lead to a college scholarship regardless of major, concert or wind ensemble is the more serious playing track that builds toward all-state and college auditions, and pursuing music as a college major means a formal conservatory or school-of-music audition. A family figures out which path fits by looking at what the kid actually wants out of senior year, not what looks most impressive."
format: "essay"
phase: "drive-there"
sport: "band"
age: 15-plus
...
The [band pathway page](/pathways/band/) breaks down what each age looks like across all three tracks, which helps when a family is trying to figure out whether this year is the year to add a second weekly lesson or just let marching season be marching season.
