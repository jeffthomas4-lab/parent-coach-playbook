---
title: "Social Media for Recruiting: Twitter, Instagram, and What Not to Post"
summary: "How to use social media to get recruited without making it weird. The bio template, the platform rules, and the cringe stories that will make sure your kid never makes them."
...
editorial:
  ...
  reviewerNotes: "Substance from Jeff (Twitter for football, Instagram for other sports, the funeral-reply anecdote, the 'kid runs the account' rule, the bio template). Drafted in his voice. Flag for Jeff to read and either approve or rework the prose."
---

→ New here? Start with [The Recruiting Process](/recruiting/the-recruiting-process/), then the [football deep-dive](/recruiting/football/) if that's your sport.
