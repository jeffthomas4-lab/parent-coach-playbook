...
level: "school"
region: "National"
durationLabel: "Nov–Mar, with AAU Apr–Jul"
summary: "Boys high school basketball in winter. Tryouts in November, regular season December through February, playoffs in February and March. AAU owns April through July."
publishedAt: 2026-04-12
months:
  - key: jan
    intensity: peak
    events: ["League play in full swing", "Holiday tournaments wrap up"]
  - key: feb
    intensity: peak
    events: ["End of regular season", "League tournament", "Senior night"]
  - key: mar
    intensity: peak
    events: ["State playoffs", "Regional and state championships"]
  - key: apr
    intensity: build
    events: ["AAU practices begin", "First AAU tournaments"]
    note: "Recovery week between school season and AAU is healthy. Most kids skip it."
  - key: may
    intensity: build
    events: ["AAU live period (rising sophomores+)", "AAU tournaments"]
  - key: jun
    intensity: peak
    events: ["AAU tournaments most weekends", "Team camp at college"]
  - key: jul
    intensity: peak
    events: ["AAU live period (NCAA July evaluation)", "Peach Jam, Adidas Gauntlet, Nike EYBL"]
    note: "Recruiting peak for college prospects. Most national exposure of the year."
  - key: aug
    intensity: rest
    events: ["Two weeks fully off (recommended)", "Open gym for HS team"]
  - key: sep
    intensity: build
    events: ["Off-season lift begins", "Open gyms 2-3x/week"]
  - key: oct
    intensity: build
    events: ["Captain's workouts", "Conditioning week"]
  - key: nov
    intensity: peak
    events: ["Tryouts (state-regulated start date)", "Roster decisions", "First practice"]
    note: "Tryout week is high-stakes. Cuts happen. Read the relevant articles before."
  - key: dec
    intensity: peak
