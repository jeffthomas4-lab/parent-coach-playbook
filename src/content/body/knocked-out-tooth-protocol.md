...
protocolSteps:
  - "Find the tooth. Pick it up by the crown (the top, white part). Do not touch the root."
  - "Rinse gently with cold water or milk if dirty. Do not scrub. Do not use soap. Do not wrap in tissue."
  - "If it's a permanent tooth, try to reimplant it back in the socket. Push gently with the crown. Have the kid bite down on a clean cloth to hold it in place."
  - "If you cannot reimplant, store the tooth in milk, the kid's saliva (in their cheek if they're old enough not to swallow it), or a tooth-preservation kit (Save-A-Tooth, HBSS). Not water."
  - "Get to a dentist or ER within 30 minutes. Survival of a reimplanted tooth drops sharply after 60 minutes."
  - "Baby teeth do not get reimplanted. They can damage the developing permanent tooth above. Take the kid to the dentist for evaluation but do not push a baby tooth back in."
  - "If there's significant facial trauma, head injury, or possible jaw fracture, ER first. Tooth second."
editorial:
  qualityGrade: 9
  originalityGrade: 7
  voiceGrade: 9
  ...
  reviewerNotes: "ADA and AAE direct sources. The 30-minute window is the published standard. The baby-tooth distinction is the most-missed piece for parents."
---
