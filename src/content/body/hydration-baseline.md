---
title: "Hydration: the baseline rules (any sport, any season)"
summary: "How much water, when, and the line between sports drinks and sugar bombs. The hydration protocol that applies year-round, not just in summer heat."
category: "hydration"
...
doctorQuestions:
  ...
  - "When is an electrolyte drink genuinely needed vs marketing?"
  - "What's the difference between hydration cramping and other cramping?"
gearPicks:
  - name: "Hydro Flask 32oz Wide Mouth"
    note: "Holds ice for 8+ hours. Kids drink more cold water."
  - name: "Yeti Rambler 26oz"
    note: "Smaller, easier to fit in a soccer bag. Same ice retention."
  - name: "LMNT electrolyte packs"
    note: "Sodium-heavy, no sugar. For practices over 90 min in heat or for high-sweater kids."
  - name: "Ultima Replenisher"
    note: "Lower-sodium electrolyte option for shorter sessions."
  - name: "CamelBak hydration backpack"
    note: "For all-day tournaments and cross-country meets."
---
