...
format: "topic"
sportTags: ["basketball", "volleyball", "baseball", "softball", "football", "lacrosse-boys", "lacrosse-girls"]
ageBands: ["all-ages"]
publishedAt: 2026-04-06
governingBodies:
  - name: "AAOS / OrthoInfo: Hand and Wrist Injuries"
...
editorial:
  ...
  reviewerNotes: "AAOS, ASSH, AAP cited. The Salter-Harris growth-plate point is the load-bearing pediatric distinction."
---
...
4. Splint in functional position. The team first-aid bag should have a finger splint and a wrist splint. Use whatever is available; a tongue depressor and tape works.

5. Apply ice over a cloth for 15 to 20 minutes.

6. Get to urgent care or pediatrician within 24 hours for any injury that meets the imaging criteria above. ER for severe deformity, vascular compromise, or open fracture.
