...
featured: true
governingBodies:
  - name: "USA Football: Heads Up Football"
    url: "https://usafootball.com/heads-up-football/"
  - name: "CDC HEADS UP"
    url: "https://www.cdc.gov/heads-up/"
  - name: "Korey Stringer Institute"
    url: "https://koreystringer.institute.uconn.edu/"
  - name: "NATA: Preseason Heat-Acclimatization Guidelines"
...
editorial:
  ...
  reviewerNotes: "Sensitive flagged. Pilot for the per-sport safety briefing format. Ranks by frequency and severity per published youth-football epidemiology. Sourced to USA Football, CDC, KSI, NATA."
---

Youth football is the most equipment-heavy youth sport and the one with the most complete published epidemiology. The list of what is actually dangerous, in order of frequency and seriousness, looks different from the list parents carry into the registration meeting.
...
"What is your heat-acclimatization plan and how does it line up with NATA?"

"Do you teach Heads Up tackling and is it the standard for tackling drills?"

"What is your concussion protocol and is it written?"

"Do you run a pre-practice ACL-prevention warm-up?"

"Is there an AED on-site and a CPR-trained adult at every practice?"

A program with answers to all five is one that has done the work. A program with one or two answers is one to push on. A program with none of the above is a program where the kid is taking on more risk than the sport requires.

**The honest read.** Youth football carries real risk. Most of it is manageable. The programs that manage it well look meaningfully different from the programs that do not, and the difference is mostly about adults preparing the way the data says to prepare. Heat protocol, tackling technique, concussion management, knee warm-up, AED readiness. Five things, in roughly that order of importance.
