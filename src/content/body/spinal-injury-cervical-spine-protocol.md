...
format: "protocol"
sportTags: ["football", "hockey", "lacrosse-boys", "cheer", "gymnastics", "swimming"]
ageBands: ["all-ages"]
publishedAt: 2026-02-06
governingBodies:
  - name: "NATA: Cervical Spine Injury Position Statement"
    url: "https://www.nata.org/"
  - name: "American College of Emergency Physicians"
    url: "https://www.acep.org/"
  - name: "AAOS / OrthoInfo: Spinal Injury"
    url: "https://orthoinfo.aaos.org/"
protocolSteps:
  - "Recognize: hit to head, neck, or back; kid is not moving on their own; complains of neck pain, tingling, numbness, or weakness in arms or legs; cannot move arms or legs."
  - "Do not move the kid. Stabilize the head in the position you find it. Hand on each side of the head, neutral position, no rotation."
  - "Call 911 immediately. State 'suspected spinal injury' clearly so dispatch sends spinal-precautions equipment."
  - "If the kid is in a helmet, do not remove it. The helmet is part of the spinal stabilization until trained EMS removes it as a unit with shoulder pads."
  - "If the kid is on their stomach (prone) and unconscious, do not roll them unless airway is compromised. Wait for EMS."
  - "If the kid is breathing and conscious, talk to them. Tell them not to move. Reassure but do not promise outcomes."
  - "Document the mechanism of injury (what happened, what hit what, from what angle). EMS will need this for the receiving hospital."
  - "Do not give the kid water, food, or medication. Keep them warm with a blanket if available."
editorial:
  qualityGrade: 10
  originalityGrade: 7
  voiceGrade: 9
