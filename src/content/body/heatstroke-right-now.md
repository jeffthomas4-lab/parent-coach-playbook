...
featured: true
governingBodies:
  - name: "Korey Stringer Institute: Exertional Heatstroke"
    url: "https://koreystringer.institute.uconn.edu/"
  - name: "NATA: Inter-Association Task Force on Exertional Heatstroke"
...
protocolSteps:
  - "Recognize: confusion, slurred speech, stopped sweating, vomiting, body temperature above 104°F, loss of coordination, collapse."
  - "Call 911."
  - "Move the kid to shade or air-conditioning immediately."
  - "Begin cold-water immersion. A tub, a stock tank, a kiddie pool. Submerge to the neck. Keep the head up."
  - "If no immersion is available, ice towels rotated continuously over the entire body, ice packs at neck, armpits, groin, and behind knees. Soak the kid with cold water."
  - "Continue cooling for 15 to 20 minutes or until rectal temperature is below 102°F. The cooling is the treatment."
  - "Cool first, transport second. The published recovery rate when cooling begins on-site approaches 100 percent. The recovery rate when transport happens before cooling drops sharply."
  - "EMS transports the kid only after cooling has begun and is continuing in transit."
editorial:
  qualityGrade: 10
  originalityGrade: 8
  voiceGrade: 9
  ...
  reviewerNotes: "Sensitive flagged. Companion to heat-and-hydration. KSI, NATA, AAP cited. The cool-first-transport-second protocol is the published lifesaver."
---
