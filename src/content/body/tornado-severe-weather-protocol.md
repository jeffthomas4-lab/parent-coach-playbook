...
governingBodies:
  - name: "National Weather Service: Tornado Safety"
    url: "https://www.weather.gov/safety/tornado"
  - name: "FEMA: Severe Weather"
    url: "https://www.ready.gov/tornadoes"
  - name: "American Red Cross: Tornado Safety"
    url: "https://www.redcross.org/get-help/how-to-prepare-for-emergencies/types-of-emergencies/tornado.html"
protocolSteps:
  - "Recognize the warning. A Tornado Warning means a tornado has been spotted or indicated by radar in your area. A Tornado Watch means conditions are favorable. The Warning is the trigger for action."
  - "Move all players, coaches, and spectators to the most substantial shelter available. Lowest level of a sturdy building. Interior room or hallway. Away from windows."
  - "If no building is available, get to a low-lying area (ditch, ravine), face down, hands covering head. Worst option but better than open field."
  - "Do not shelter in a vehicle, mobile home, or covered metal structure. These offer minimal protection."
  - "Account for every player, coach, and chaperone by name. Roster check, eyes on each kid."
  - "Stay sheltered until the warning is officially lifted by NWS, not based on the visible weather. Tornadoes can be wrapped in rain or hidden by darkness."
  - "After the warning is lifted, walk the area for downed power lines, debris, or structural damage before resuming. Do not resume play if any field-area damage is visible."
  - "If a tornado has touched down nearby, treat the field as a search-and-rescue area until first responders clear it."
editorial:
  qualityGrade: 9
  originalityGrade: 8
  voiceGrade: 9
  ...
  reviewerNotes: "Sensitive flagged. NWS, FEMA, ARC cited directly. Practical sheltering hierarchy."
---
