...
governingBodies:
  ...
  - name: "CDC HEADS UP: Return to Play"
    url: "https://www.cdc.gov/heads-up/"
  - name: "Concussion Legacy Foundation"
    url: "https://concussionfoundation.org/"
protocolSteps:
  - "Stop play. The kid is out for the day. No exceptions."
  - "Move the kid to the sideline or a quiet area. No bright lights, no loud talking."
  - "Check for red-flag symptoms: loss of consciousness, severe headache, repeated vomiting, seizure, slurred speech, weakness on one side, neck pain, or worsening confusion. Any of those, call 911."
  - "If no red flags, observe. Note dazed look, balance issues, sensitivity to light or noise, memory gaps, slow response to questions. These are symptoms even without LOC."
  - "Notify the parent if the parent is not present. Do this within minutes."
  - "Send the kid home with a responsible adult. Quiet rest the rest of the day. No screens, no driving, no return to practice."
  - "Schedule pediatrician or sports-medicine evaluation within 24 to 48 hours."
  - "Do not return to play same day. Do not return to play the next day. Return only after written clearance from a licensed health care provider, per your state law."
editorial:
  qualityGrade: 9
  originalityGrade: 8
  voiceGrade: 9
