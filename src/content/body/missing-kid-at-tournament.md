...
governingBodies:
  ...
  - name: "U.S. Department of Justice: Crime Prevention"
    url: "https://www.justice.gov/"
  - name: "American Red Cross: Family Safety"
    url: "https://www.redcross.org/"
protocolSteps:
  - "Stop. Pause and take 30 seconds to gather information. Last seen where, with whom, what wearing, time."
  - "Call the kid's phone. Text the kid's phone. Text the team chat to ask if anyone has seen the kid."
  - "Send the team manager and one other adult on a structured search of the immediate venue. Bathrooms, snack bar, parking lot, team-room, last known location."
  - "Notify the head coach and at least one parent (yours or the missing kid's). The coach pauses any team activity and gets eyes on every other team kid."
  - "At minute 5 if not found: notify the tournament director. They have access to the venue PA system and security."
  - "At minute 10 if not found: call 911. Do not wait longer. Time is the variable that matters."
  - "Provide the police with: full name, age, height, weight, hair, eye color, what wearing, last seen location and time, photo from your phone if available."
  - "Stay at the venue command point. The kid almost always shows up there or nearby. Do not chase a sighting that has not been confirmed."
editorial:
  qualityGrade: 9
  originalityGrade: 9
  voiceGrade: 9
  ...
  reviewerNotes: "Sensitive flagged. Practical first-10-minutes protocol. NCMEC and DOJ cited. The 'do not wait past 10' rule aligns with NCMEC guidance to call promptly rather than wait the old 24-hour myth."
---
