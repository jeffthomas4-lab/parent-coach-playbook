---
title: "Recovery basics: foam rolling, ice, sleep, repeat"
summary: "What actually helps a kid recover between practices and games. The recovery gear that's worth the money and the gear that's mostly marketing."
category: "recovery"
sportTags: ["multi-sport"]
ageBands: ["11-12", "13-14", "15-plus"]
publishedAt: 2026-04-25
governingBodies:
  - name: "NSCA: Youth Strength and Conditioning Position Statement"
    url: "https://journals.lww.com/nsca-jscr/fulltext/2009/08000/youth_resistance_training__updated_position.40.aspx"
  - name: "AAP: Strength Training by Children and Adolescents"
    url: "https://publications.aap.org/pediatrics/article/121/4/835/72624"
doctorQuestions:
  - "Is foam rolling appropriate for a kid this age?"
  - "When does soreness cross from normal recovery to actual injury?"
  - "Is cold water immersion (ice baths) safe for kids?"
  - "What about pneumatic compression sleeves like Normatec: useful or hype?"
gearPicks:
  - name: "Foam roller (TriggerPoint Grid 13-inch)"
    note: "Standard foam roller. Quads, IT band, calves, glutes, lats. Daily use is fine for ages 12+."
  - name: "Lacrosse ball or massage ball"
    note: "For trigger-point work on small muscles. Especially feet, glutes, between shoulder blades."
  - name: "Theragun (or Hyperice or Bob and Brad knockoff)"
    note: "Massage gun. Genuinely useful for warm-up and post-workout. Kid-safe with light pressure."
  - name: "Mini bands and lacrosse ball set"
    note: "Pre-practice activation work. Lower cost, higher use than fancy recovery gear."
  - name: "Plyo box (24-inch)"
