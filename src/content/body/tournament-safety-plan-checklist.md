...
governingBodies:
  ...
  - name: "American Red Cross: Travel Safety"
    url: "https://www.redcross.org/"
  - name: "American Heart Association: AED Programs"
    url: "https://cpr.heart.org/en/resources/aed-implementation"
checklistItems:
  - "Master roster with each player's emergency contact, allergies, medications, and insurance info"
  - "Signed transportation consent form on file for every player"
  - "Hotel rooming chart showing minor-with-minor pairings, adults next door"
  - "Two named chaperones with phone numbers, plus one alternate"
  - "Written curfew with bed-check protocol"
  - "Closest hospital and urgent care to each tournament venue"
  - "AED location at each venue confirmed in advance"
  - "Sideline first-aid kit fully stocked and on-site"
  - "Coach and one chaperone CPR/AED certified"
  - "Heat/lightning policy confirmed with tournament organizer"
...
editorial:
  ...
  reviewerNotes: "Practical checklist consolidating the safety stack a tournament weekend should have. SafeSport, Red Cross, AHA cited."
---
