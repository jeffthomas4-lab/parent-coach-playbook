...
featured: true
governingBodies:
  - name: "National Weather Service: Lightning Safety"
...
protocolSteps:
  ...
  - "Inside a vehicle is the second-best option if no building is available. Hard-topped car with windows up. Stay away from metal."
  - "Avoid open fields, hilltops, isolated trees, water, metal fences, and metal bleachers."
  - "Do not resume play until 30 minutes have passed since the last lightning flash or thunderclap."
  - "Reset the 30-minute clock with each new flash or rumble. The clock does not run down while storms are still active."
  - "If a person is struck and is not breathing, start CPR immediately. Lightning-strike victims are not electrically charged after the strike. They can be touched safely."
editorial:
  qualityGrade: 9
  originalityGrade: 7
  voiceGrade: 9
  ...
  reviewerNotes: "NWS, NFHS, NCAA all sourced. The 30/30 rule is the published standard. Concise moment-page format."
---
