...
governingBodies:
  - name: "American Red Cross: First Aid Resources"
...
checklistItems:
  ...
  - "Medical tape (1 inch, athletic)"
  - "Self-adherent wrap (Coban or equivalent)"
  - "Elastic bandage (ACE wrap, two sizes)"
  - "Instant cold packs (4)"
  - "Antiseptic wipes (single-use, 30+)"
  - "Antibiotic ointment (single-use packets, 12+)"
  - "Nitrile gloves (non-latex, 6 pairs)"
  - "Trauma shears (blunt-tip)"
  - "Tweezers (fine-point)"
  - "Triangular bandage (cravat) for slings"
  - "CPR face shield with one-way valve"
  - "Rescue blanket (mylar)"
  - "Hand sanitizer"
  - "Tampons or menstrual pads (for athletes who need them and for nosebleeds, surprisingly effective)"
  - "Sunscreen (SPF 30+, broad-spectrum)"
  - "Insect repellent"
  - "Glucose tablets or juice (for hypoglycemia in known diabetics)"
  - "Saline eyewash bottle"
  - "Splints (one finger, one wrist)"
  - "Emergency contact and medical-info cards for every player"
checklistPdf: "/printables/sideline-first-aid-kit.pdf"
editorial:
  qualityGrade: 8
  originalityGrade: 7
  voiceGrade: 8
  ...
  claudeReviewedAt: 2026-02-10
  status: claude-reviewed
  reviewerNotes: "Practical checklist. Red Cross and NATA cited. The tampon-for-nosebleed line is a well-documented EMT trick that parents will appreciate hearing once."
---
