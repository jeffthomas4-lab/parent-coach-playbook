...
governingBodies:
  - name: "Association for Applied Sport Psychology (AASP)"
    url: "https://appliedsportpsych.org/"
  - name: "American Psychological Association (APA): Division 47 — Society for Sport, Exercise and Performance Psychology"
...
1. Identify what the kid actually needs. Performance enhancement? Clinical mental health support? Both?

2. For clinical concerns, start with the pediatrician for referral to licensed providers.

3. For performance enhancement, look for AASP-certified CMPCs through their online directory.

4. Verify credentials directly through the issuing body.

5. Ask for an initial consultation. Most legitimate providers offer 15 to 30 minutes free or low-cost to assess fit.

6. Coordinate with the kid's other care (pediatrician, athletic trainer, primary coach).
