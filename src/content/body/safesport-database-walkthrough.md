...
governingBodies:
  - name: "U.S. Center for SafeSport: Centralized Disciplinary Database"
    url: "https://uscenterforsafesport.org/response-and-resolution/centralized-disciplinary-database/"
  - name: "U.S. Olympic & Paralympic Committee (USOPC)"
...
editorial:
  ...
  claudeReviewedAt: 2026-01-30
  status: claude-reviewed
  reviewerNotes: "Sensitive flagged. SafeSport CDD is the load-bearing public tool. Walkthrough is concrete."
---
...
1. Open uscenterforsafesport.org.

2. Click "Response and Resolution" in the main menu (or navigate directly to the CDD page).

3. Click "Search the Database."

4. Enter the coach's first and last name. Search is case-insensitive.
