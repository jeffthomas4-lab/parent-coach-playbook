...
governingBodies:
  - name: "National Athletic Trainers' Association (NATA): Heat Cramps Position Statement"
    url: "https://www.nata.org/"
  - name: "Korey Stringer Institute (KSI)"
...
editorial:
  ...
  reviewerNotes: "NATA, KSI, AAP cited. The sodium-and-fluid combination is the published protocol, often misunderstood as just hydration."
---
...
4. Rest for 30 to 60 minutes after symptoms resolve. The kid does not return immediately. The underlying sodium balance takes time to restore.

5. Monitor for progression to heat exhaustion or heatstroke. The kid with new symptoms (confusion, severe headache, vomiting, mental status changes) is moving toward heat exhaustion or heatstroke. Different protocol then.
