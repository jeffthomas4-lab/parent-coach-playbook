...
checklistItems:
  - "Uniform tops (one per game expected, plus one spare)"
  - "Uniform bottoms (one per game expected, plus one spare)"
  - "Game socks (one pair per game, plus two spare)"
  - "Practice clothes for warm-ups and walking around"
  - "Sweatshirt or warm-up jacket"
  - "Light jacket or hoodie for evening"
  - "Rain gear if outdoor venue"
  - "Pajamas"
  - "Underwear (one per day plus two spare)"
  - "Sport-specific shoes (cleats, basketball shoes, etc.)"
  - "Backup pair of sport shoes if first pair has issue"
  - "Sandals or slides for between games"
  - "Sport-specific protective gear (mouthguard, helmet, etc.)"
  - "Sport-specific equipment (glove, stick, racket, etc.)"
  - "Spare equipment items (extra mouthguard, extra laces)"
  - "Water bottle (24 to 32 oz)"
  - "Sports drink for between games"
  - "Snacks for between games (granola bars, fruit, sandwiches, jerky)"
  - "Toiletries (toothbrush, toothpaste, deodorant, shampoo, soap)"
  - "Sunscreen if outdoor venue (SPF 30+)"
  - "Lip balm with SPF"
  - "Bug spray if outdoor venue in season"
  - "Medications, prescription and OTC (Tylenol/ibuprofen, allergy meds, etc.)"
  - "Asthma inhaler if applicable"
  - "EpiPen if applicable, with backup"
  - "Insurance card (copy in kid's bag)"
  - "Emergency contact card with parent phone, allergies, conditions"
  - "Cash and/or debit card for snacks and emergencies"
  - "Phone and charger"
  - "Portable battery pack"
  - "Headphones"
  - "Book or activities for downtime"
  - "Schoolwork if traveling during school week"
  - "Sleep aids if needed (eye mask, earplugs, white-noise app)"
  - "Hair ties, hair gel, hair-care items as needed"
  - "Small first-aid kit (band-aids, antibiotic ointment, athletic tape)"
  - "Ziplock bags for wet uniforms"
  - "Laundry bag for dirty clothes"
  - "Reusable shopping bag for additional gear"
  - "Travel pillow if road trip"
checklistPdf: "/printables/tournament-packing-list.pdf"
editorial:
  qualityGrade: 8
  originalityGrade: 7
  voiceGrade: 8
  ...
  reviewerNotes: "Practical master list. AAP and TSA cited where relevant for specific items."
---
