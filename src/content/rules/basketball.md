...
scoringBasics:
  ...
  - "Shot beyond the 3-point arc: 3 points."
  - "Free throw: 1 point each. Awarded for fouls in the act of shooting and for accumulated team fouls (after 7-10 fouls in a half)."
commonCalls:
  - "Personal foul: illegal contact with another player. Free throws if the foul was in the act of shooting. Five fouls = fouled out (six in NBA)."
  - "Technical foul: unsportsmanlike conduct, can be called on player or coach. Two = ejection."
  - "Traveling: more than two steps without dribbling. Possession changes."
  - "Double dribble: dribble, stop, dribble again. Possession changes."
  - "Carrying/palming: hand under the ball during the dribble. Possession changes."
  - "Out of bounds: ball or player touches the line or beyond. Possession to the team that didn't touch it last."
  - "5-second violation: failure to inbound the ball within 5 seconds; or holding the ball without dribbling/shooting/passing within 5 seconds while closely guarded."
  - "10-second violation (HS+): offensive team fails to advance the ball past half-court within 10 seconds."
  - "Shot clock (HS varies, college and NBA): possession ends if no shot is attempted within the clock."
thingsParentsGetWrong:
  - "The 'over the back' call. Not actually a rule per se. Refs call it as a foul if there's contact, but reaching over a player's back to rebound without contact isn't a foul."
  - "Charge vs block. The defender must be in a legal guarding position (set, both feet on the floor, facing the ball-handler) before contact. Charges are getting called less at the youth level than they used to be."
  - "Continuous motion on the shot. If the foul happens while the player is in the act of shooting (the upward shooting motion has begun), free throws are awarded even if the shot misses."
governingBody:
  name: "USA Basketball"
