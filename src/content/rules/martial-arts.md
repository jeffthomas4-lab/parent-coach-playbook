---
sport: "martial-arts"
title: "Martial arts: rules at-a-glance"
summary: "Many disciplines, one structure: belts, forms, sparring. The shared rules of youth martial arts in five minutes."
fieldSetup: "Dojo, dojang, or training space with mats. Tournament setup: square or octagonal mat (sizes vary by discipline). Scoring panel of judges."
gameLength: "Belt promotion testing typically runs 1-3 hours. Tournaments: each kid competes in 1-3 events (forms/kata, sparring/kumite, sometimes weapons), each event lasting 1-3 minutes."
scoringBasics:
  - "Belt advancement: instructor/master determines readiness based on time-in-rank, skill demonstration, and sparring competence."
  - "Tournament forms (kata/poomsae): judges score on technique, power, balance, presentation."
  - "Tournament sparring: points scored for legal contact to scoring areas (varies by discipline)."
commonCalls:
  - "Illegal contact: hitting prohibited targets (varies by discipline and age). Penalty or DQ."
  - "Excessive force: contact above allowed levels for the age/level. Penalty."
  - "Out of bounds: stepping outside the competition area. Warning then point loss."
