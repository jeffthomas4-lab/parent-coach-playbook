---
sport: "tennis"
title: "Tennis: rules at-a-glance"
summary: "Court, net, racket, ball. Win games, win sets, win matches. The rules of youth tennis in five minutes."
fieldSetup: "Rectangular court divided by a net. 78 ft long × 27 ft wide (singles) or 36 ft (doubles). Service boxes near the net. Baseline at the back."
gameLength: "Match length varies. Best-of-3 sets is standard at most levels (best-of-5 at men's pro Grand Slams). Each set is first to 6 games (with a 7-point tiebreak at 6-6). Matches typically run 60-180 minutes."
scoringBasics:
  - "Game: 0-15-30-40-game (with deuce/advantage at 40-40)."
  - "Set: first to 6 games, must win by 2. Tiebreak at 6-6 in most formats."
  - "Match: best-of-3 sets typical. Pro tour men's slams = best-of-5."
commonCalls:
  - "Out: ball lands outside the line. The line itself is in. Player or umpire calls it."
  - "Let: serve clips the net but lands in the service box. Serve replayed. Other lets (cord shots in play) are increasingly being eliminated."
  - "Foot fault: server's foot crosses the baseline before contact. Loss of point."
  - "Double bounce: ball bounces twice before being struck. Loss of point."
...
editorial:
  ...
  reviewerNotes: "The 'parents stay out of line-call disputes' point is the most-needed parent guidance. Junior tennis self-officiating is a frequent source of conflict."
---
