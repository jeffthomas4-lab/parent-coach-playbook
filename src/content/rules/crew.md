---
sport: "crew"
title: "Crew (rowing): rules at-a-glance"
summary: "Boats, oars, water, six lanes. The rules of youth rowing in five minutes."
fieldSetup: "Race course is typically 2,000 meters at HS+ (1,500m at U17 and below). 6 lanes. Buoyed every 250 meters. Start platform at one end, finish line at the other."
gameLength: "Each race is 5-9 minutes depending on distance and conditions. Regattas run all day with multiple heats."
scoringBasics:
  - "First boat across the finish line wins."
  - "Heats and finals: top boats from heats advance to finals."
  - "Team scoring at multi-event regattas: points by place finish."
commonCalls:
  - "False start: starting before the official signal. Restart with warning; second offense = DQ."
  - "Lane violation: rowing into another lane. Warning, then DQ if not corrected."
  - "Equipment failure: broken rigger or oar in first 100m allows a restart."
  - "Steering infraction: bow-loader (in a 4+ or 8+) is responsible for steering; serious deviation = DQ."
thingsParentsGetWrong:
  - "Rowing is a team sport in 4s and 8s: a perfect race requires every rower in sync. The strongest boat doesn't always win; the most-coordinated does."
  - "Erg scores (rowing machine times) get talked about a lot. They matter for college recruiting but the boat performance is the real metric."
  - "Coxswain is a real position. The smaller athlete who steers and calls the race is essential to boat speed; not a 'lesser' role."
governingBody:
  name: "USRowing"
