---
sport: "cheer"
title: "Competitive cheer: rules at-a-glance"
summary: "Tumbling, stunts, jumps, dance. Two and a half minutes on the mat. The rules of all-star cheer in five minutes."
fieldSetup: "Performance mat (typically 42 ft × 54 ft for all-star competition). Spring floor underneath for tumbling and stunting safety. Judging panel in front."
gameLength: "Each routine is 2:30 (two minutes thirty seconds). Each team performs once per competition (twice in finals format)."
scoringBasics:
  - "Score includes: tumbling, stunts, pyramids, basket tosses, jumps, dance, overall execution."
  - "Difficulty bonuses for higher-level skills."
  - "Deductions for falls, errors, safety violations, time/boundary violations."
  - "USASF level system (1-7) determines what skills are allowed for each team's age and ability."
commonCalls:
  - "Fall: stunt or pyramid hits the floor. Significant deduction."
  - "Out of bounds: athlete steps outside the performance mat. Small deduction."
  - "Time violation: routine over 2:30 = deduction; well over = significant deduction."
  - "Illegal skill: performing a skill above the team's level. Major deduction or DQ."
  - "Crossover violation (in some divisions): athlete competing for multiple teams in violation of rules."
thingsParentsGetWrong:
  - "Cheer at the all-star level is its own sport. Different from sideline cheer at school games. Different from competitive Stunt (NCAA emerging sport)."
  - "Levels are determined by team-allowed skills, not just age. A 14-year-old on a Level 3 team isn't doing the same skills as a 14-year-old on a Level 6 team."
  - "Stunting injuries are real. Concussion, ankle, wrist, back. The body hub applies."
governingBody:
  name: "USASF (US All Star Federation)"
  url: "https://www.usasf.net/"
ruleBookUrl: "https://www.usasf.net/age-divisions-rules"
...
editorial:
  ...
  reviewerNotes: "All-star cheer specifically (not sideline cheer). The level system is the biggest source of parent confusion."
---
