---
sport: lacrosse
title: "Lacrosse rules: a five-minute primer for first-time parents"
summary: "What youth lacrosse looks like, how the field is set up, how scoring works, and the calls parents hear most often but do not always understand."
fieldSetup: "A lacrosse field is roughly 110 yards long and 60 yards wide with a goal at each end. The goal sits inside a circular crease that only the goalie can occupy. The field is divided at midfield. Boys lacrosse uses 10 players per side (3 attack, 3 midfield, 3 defense, 1 goalie). Girls lacrosse uses 12 per side with different contact rules."
gameLength: "Most youth lacrosse games run four 8–12 minute quarters with a running clock, stopping only for injuries and timeouts. Total game time is typically 60–75 minutes. High school games run four 12-minute quarters."
scoringBasics:
