...
export const POST: APIRoute = async ({ params, request }) => {
  ...
  const logger = createRequestLogger(request, { route: 'admin/editorial/claims/validate', userId: auth.email });
  ...
  try {
    ...
    logger.error('editorial_record_write_failed', error, { claimId: params.id });
