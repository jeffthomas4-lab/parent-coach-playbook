...
export const POST: APIRoute = async ({ request }) => {
  ...
  const logger = createRequestLogger(request, { route: 'admin/editorial/approvals/update', userId: auth.email });
  ...
  try {
    ...
    logger.error('editorial_record_write_failed', error, { action, opportunityId: body.opportunity_id });
