...
const id = "when-a-parent-emails-about-playing-time.md";
						const collection = "articles";
						const slug = "when-a-parent-emails-about-playing-time";
						...
						const data = {title:"The 8-10 Ages: When a Parent Emails About Playing Time",seoDescription:"This email comes in during week two. \"My kid isn't getting much playing time. What can we do to help him improve?\"",dek:"They're asking a fair question. Here's the answer structure that works.",topic:"communication",format:"note",sport:"multi-sport",age:"8-10",phase:"drive-home",publishedAt:new Date(1769472000000),featured:false,draft:false,editorial:{flagInappropriateness:false,flagIpRisk:false,flagSensitiveTopic:false,citationCheckPassed:false,sportLanguageCheckPassed:false,affiliateDisclosurePresent:false,claudeReviewedAt:new Date(1774137600000),status:"draft"}};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/jeffthomas/Desktop/Claude Cowork/Outputs/parent-coach-playbook/src/content/articles/when-a-parent-emails-about-playing-time.md",
							rawData: undefined,
						};
