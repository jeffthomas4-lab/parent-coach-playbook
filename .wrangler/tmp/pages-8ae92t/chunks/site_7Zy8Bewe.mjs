...
const SITE = {
  ...
  description: "Sideline notes for parents who are deep in their kid's youth sports, theater, band, or whatever else is on the schedule this week. Short, honest, occasionally funny.",
...
const CAMP_SPORTS = [...SPORTS, ...CAMP_ONLY_SPORTS].slice().sort((a, b) => a.label.localeCompare(b.label));
const AGE_BANDS = [
  { slug: "5-7", label: "5–7" },
...
const DEFAULT_THEME = { accent: "#C5713D", accentBg: "#F2E2D5" };
function themeFor(slug) {
  if (!slug) return DEFAULT_THEME;
  return SECTION_THEMES[slug] ?? TOPIC_THEMES[slug] ?? DEFAULT_THEME;
}

export { AGE_BANDS as A, BUYING_GUIDES as B, CAMP_SPORTS as C, EDITORIAL as E, NAV as N, PILLARS as P, SPORTS as S, TOPICS as T, UTILITY_NAV as U, SITE as a, authorEntity as b, TEAM_PARENT_TOPICS as c, TEAM_PARENT_CATEGORIES as d, TOOLS_NAV as e, personSchema as p, themeFor as t };
