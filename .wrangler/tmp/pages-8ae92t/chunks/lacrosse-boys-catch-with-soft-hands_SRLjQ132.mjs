...
const id = "lacrosse-boys-catch-with-soft-hands.md";
						const collection = "coachingTips";
						const slug = "lacrosse-boys-catch-with-soft-hands";
						...
						const data = {title:"Catch with Soft Hands",summary:"Receive a pass without the ball bouncing out. 10 minutes. Ages 8-10.",sport:"lacrosse-boys",ages:["8-10"],fundamental:"catching",progression:"intro",focus:"fundamentals",layer:"foundations",illustrationBrief:"Player receiving a pass with the lacrosse stick head, the stick giving slightly back as the ball arrives so it doesn't bounce out.",publishedAt:new Date(1777680000000),featured:false,draft:false,editorial:{qualityGrade:8,originalityGrade:7,voiceGrade:8,flagInappropriateness:false,flagIpRisk:false,flagSensitiveTopic:false,citationCheckPassed:true,sportLanguageCheckPassed:true,affiliateDisclosurePresent:true,claudeReviewedAt:new Date(1778284800000),status:"claude-reviewed",reviewerNotes:"Soft-hands catch fundamentals for ages 8-10."}};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/jeffthomas/Desktop/Claude Cowork/Outputs/parent-coach-playbook/src/content/coachingTips/lacrosse-boys-catch-with-soft-hands.md",
							rawData: undefined,
						};
