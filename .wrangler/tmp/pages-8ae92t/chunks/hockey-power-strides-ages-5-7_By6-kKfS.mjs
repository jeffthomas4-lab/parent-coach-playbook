...
const html = "<p>Young skaters often shuffle. This drill teaches them to push hard on each stride, building power and control at the same time.</p>\n<p><strong>Equipment needed:</strong> 8 cones, no puck.</p>\n<p><strong>Setup:</strong> Create a straight line of cones 10 yards long, spaced 2 feet apart. Kids line up at one end.</p>\n<p><strong>How to run it:</strong></p>\n<ol>\n<li>Skater starts slow, focusing on pushing hard with each leg, not moving fast yet. Each stride should feel like the skater is driving their leg back and out, not shuffling forward.</li>\n<li>Skater accelerates down the line of cones, pushing on every stride. They should feel like they’re getting faster with each push, not just gliding.</li>\n<li>Do 3 reps at controlled speed, then 3 reps at game speed.</li>\n<li>Rest, then repeat.</li>\n</ol>\n<p><strong>What to look for:</strong></p>\n<p>The back leg should extend fully on each push. If a skater is taking quick, short steps without extension, they’re shuffling. A power stride has visible extension and a brief “load” phase where the skating leg is bent before the push. The torso should stay upright. If a skater is leaning forward, they’re fighting gravity instead of using it.</p>\n<p><strong>Variation:</strong> For kids who pick it up fast, add a finish line and time the trip. Or have them carry a stick to start building the body shape they will use with a puck later.</p>\n<hr>\n<p><strong>Gear for this drill</strong> (affiliate)</p>\n<p><a href=\"/go/hockey-puck/\" rel=\"sponsored nofollow noopener\" target=\"_blank\">Hockey pucks (6-pack) →</a> — regulation pucks for drills and scrimmage.</p>\n<p><a href=\"/go/hockey-stick-youth/\" rel=\"sponsored nofollow noopener\" target=\"_blank\">Youth hockey stick →</a> — Franklin Ripper, flex rated for young players.</p>\n<p><a href=\"/what-to-buy/hockey/\">Full hockey gear guide →</a> — all picks by age, sport, and level.</p>\n<p><em>As an Amazon Associate we earn from qualifying purchases.</em></p>";

				const frontmatter = {"title":"Power-Stride Skating","summary":"Teach young skaters explosive leg drive with short, powerful pushes. 10 minutes.","sport":"hockey","ages":["5-7"],"focus":"fundamentals","layer":"foundations","fundamental":"skating","progression":"intro","illustrationBrief":"A young skater pushing hard on each stride across the ice, extending the legs with force and recovering quickly.","publishedAt":"2026-02-14T00:00:00.000Z","featured":false,"editorial":{"qualityGrade":7,"originalityGrade":6,"voiceGrade":7,"flagInappropriateness":false,"flagIpRisk":false,"flagSensitiveTopic":false,"citationCheckPassed":true,"sportLanguageCheckPassed":true,"affiliateDisclosurePresent":true,"claudeReviewedAt":"2026-05-09T00:00:00.000Z","status":"claude-reviewed","reviewerNotes":"Variation was truncated. Completed it."}};
				const file = "C:/Users/jeffthomas/Desktop/Claude Cowork/Outputs/parent-coach-playbook/src/content/coachingTips/hockey-power-strides-ages-5-7.md";
				const url = undefined;
				function rawContent() {
