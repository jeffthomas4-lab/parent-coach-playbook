...
| What every family decides for itself (no judgment from us) | Editorial | Foundations | PIPELINE (checked 2026-09-03, genuinely uncovered, not thin enough to mark redundant; passed over this run for a timelier Rules Watch item, see below. Next run should draft this one.) |
