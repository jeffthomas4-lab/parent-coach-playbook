...
| # | Action | Why |
|---|---|---|
| 1 | ~~**Fix GSC access** (add support@parentcoachdesk.com as owner, or verify sc-domain property)~~ **Done — access was never broken.** Camps sitemap recovery + resubmit done 2026-07-05. | Blocks all SEO measurement; 5-minute fix |
...
| 3 | ~~**Internal-linking sprint on articles:** tips are done (542/577); articles are at 55/713.~~ **Done 2026-07-05.** All 269 single-sport articles now link to their own gear guide/pathway page (165 added). Guide ↔ pathway ↔ season-calendar cross-linking done in a same-day follow-up: all 26 guide/pathway pairs now link to each other and to their season calendar. Found and fixed two pre-existing content bugs along the way (a truncated `football.md` guide, a corrupted duplicate section in `lacrosse-girls.md`). | Feeds money pages; biggest on-site SEO win available |
